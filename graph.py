...
def create_property_valuation_workflow():
    """Create the property valuation workflow"""
    
    # Create the state graph
    workflow = StateGraph(PropertyValuationState)
    
    # Add nodes
    workflow.add_node("data_collection", property_data_collection_node)
    workflow.add_node("comparables", comparable_properties_node)
    workflow.add_node("market_analysis", market_analysis_node)
    workflow.add_node("final_valuation", final_valuation_node)
...
def create_conditional_property_valuation_workflow():
    """Create property valuation workflow with conditional routing"""
